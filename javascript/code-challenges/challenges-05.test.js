...
const addValues = (arr) => {
  let values = arr.reduce(function(accumulator, value){
...
const addPurchases = (arr) => {
  let total = arr.reduce(function(accumulator,value){
...
const countNumberOfElements = (arr) => {
  ...
  let newArray = arr.reduce(function(accumulator, value,idx){
    accumulator + value;
    idx++;
    return idx;
  },0);
...
const returnNames = (arr) => {
  let arrayOfNames = arr.reduce(function(accumulator, value,idx){
